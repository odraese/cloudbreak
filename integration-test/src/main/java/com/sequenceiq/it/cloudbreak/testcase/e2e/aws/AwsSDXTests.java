...
public class AwsSDXTests extends AbstractE2ETest {
    ...
    public void testCreatedSDXShouldBeSuccess(TestContext testContext) throws IOException {
        ...
        testContext
                ...
                .withBlueprintName("CDP 1.0 - SDX: Apache Hive Metastore, Apache Ranger, Apache Atlas")
                ...
                .then((ct, stackDto, cloudbreakClient) -> stackTestClient.getV4().action(ct, stackDto, cloudbreakClient))
                .validate();
    }
}
