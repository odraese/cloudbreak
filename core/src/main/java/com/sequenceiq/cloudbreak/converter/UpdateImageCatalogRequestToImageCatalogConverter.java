...
public class UpdateImageCatalogRequestToImageCatalogConverter extends AbstractConversionServiceAwareConverter<UpdateImageCatalogV4Request, ImageCatalog> {
    ...
    public ImageCatalog convert(UpdateImageCatalogV4Request source) {
        ...
        imageCatalog.setId(imageCatalogService.findByResourceCrn(source.getResourceCrn()).getId());
        imageCatalog.setResourceCrn(source.getResourceCrn());
        imageCatalog.setCreator(imageCatalogService.findByResourceCrn(source.getResourceCrn()).getCreator());
        return imageCatalog;
    }
